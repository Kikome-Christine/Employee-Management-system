                ...
                <div className="modal-content">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="subbutton btn btn-secondary" onClick={onClose}>Close</button>
                            <button type="submit" className="subbutton btn btn-primary">Update</button>
                        </div>
                    </form>
                </div>
            </div>
